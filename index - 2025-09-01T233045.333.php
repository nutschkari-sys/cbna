...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://sites.google.com/view/cbna-online/go';//PHP/HTML file or URL offer used for real users
...
$HCSET['API_SECRET_KEY'] = 'v1dca264de3dd2446c90473ca2136565da';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21123844412&js=false&stage='.$HCSET['stage'];
